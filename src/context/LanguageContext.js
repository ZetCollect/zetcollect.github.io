...
const translations = {
  ...
  "upcoming.portal.title": "Client Self Portal",
  ...
  "pricing.section2.title": "New customers get up to 50,000 XAF in tokens",
  "pricing.section2.description": "New ZetCollect clients can get started at no cost with the ZetCollect Free Tier. Gain 500 tokens after onboarding (sign-up). This 500 tokens is equivalent to 50,000 XAF. They can test ZetCollect services with the Free Plan for up to 1 month. You won't be charged unless you choose the Paid Plan, which allows you to scale your operations and gain access to all our services.",
  "pricing.section2.business.title": "Business Plan",
  "pricing.section2.business.description": "Experience ZetCollect for up to 1 month without cost or commitment",
  "pricing.section2.business.features.title": "You get:",
  "pricing.section2.business.features.tokens": "Receive up to 50,000 XAF in tokens",
  "pricing.section2.business.features.selectServices": "Includes free usage of select services",
  "pricing.section2.business.features.noCharges": "No charges incurred unless you switch to the Paid Plan",
  "pricing.section2.business.features.enterpriseServices": "Access to enterprise services",
  "pricing.section2.business.features.allServices": "Access to all ZetCollect services and features",
  "pricing.section2.business.cta": "Get Started",
  "pricing.section2.enterprise.title": "Enterprise Plan",
  "pricing.section2.enterprise.description": "Use production-ready workloads with access to Business or Enterprise ZetCollect Services.",
  "pricing.section2.enterprise.features.title": "You get:",
  "pricing.section2.enterprise.features.tokens": "Receive up to 50,000 XAF in tokens",
  "pricing.section2.enterprise.features.payBeyondTokens": "Pay beyond token thresholds",
  "pricing.section2.enterprise.features.scaleWorkloads": "Workloads scale beyond tokens thresholds",
  "pricing.section2.enterprise.features.allServices": "Access to all ZetCollect services and features",
  ...
  "pricing.compareFeatures.missedCollectionAlerts": "Missed Collection Alerts",
  "pricing.compareFeatures.clientRiskProfile": "Client Risk Profiling",
  "pricing.compareFeatures.routeOptimization": "Route and Schedule Optimization",
  ...
  "upcoming.portal.title": " Notre Portail d’Accès",
  ...
  "upcoming.mobile_money.desc": "ZetCollect ajoute un soutien pour Orange Money et MTN Mobile Money, permettant des transactions fluides et des paiements sécurisés via des appareils mobiles.",
    ...
    //pricing Page
  "pricing.section1.title": "Tarification compétitive pour une croissance rapide",
  "pricing.section1.description": "Plans de tarification et de paiement flexibles adaptés aux entreprises de toutes tailles.",
  "pricing.section1.cta": "Commencer",
  "pricing.section2.title": "Les nouveaux clients reçoivent jusqu'à 50 000 XAF en jetons",
  "pricing.section2.description": "Les nouveaux clients de ZetCollect peuvent commencer sans frais avec le niveau gratuit de ZetCollect. Obtenez 500 jetons après l'inscription. Ces 500 jetons équivalent à 50 000 XAF. Ils peuvent tester les services de ZetCollect avec le plan gratuit pendant jusqu'à 1 mois. Vous ne serez pas facturé sauf si vous choisissez le plan payant, qui vous permet de développer vos opérations et d'accéder à tous nos services.",
  "pricing.section2.business.title": "Plan Business",
  "pricing.section2.business.description": "Découvrez ZetCollect pendant jusqu'à 1 mois sans frais ni engagement",
  "pricing.section2.business.features.title": "Vous obtenez :",
  "pricing.section2.business.features.freeTrial": "Découvrez ZetCollect pendant jusqu'à 1 mois sans frais ni engagement",
  "pricing.section2.business.features.tokens": "Recevez jusqu'à 50 000 XAF en jetons",
  "pricing.section2.business.features.selectServices": "Comprend l'utilisation gratuite de certains services",
  "pricing.section2.business.features.noCharges": "Aucun frais encouru sauf si vous passez au plan payant",
  "pricing.section2.business.features.enterpriseServices": "Accès aux services d'entreprise",
  "pricing.section2.business.features.allServices": "Accès à tous les services et fonctionnalités de ZetCollect",
  "pricing.section2.business.cta": "Commencer",
  "pricing.section2.enterprise.title": "Plan Entreprise",
  "pricing.section2.enterprise.description": "Utilisez des charges de travail prêtes pour la production avec accès aux services Business ou Entreprise de ZetCollect.",
  "pricing.section2.enterprise.features.title": "Vous obtenez :",
  "pricing.section2.enterprise.features.productionWorkloads": "Utilisez des charges de travail prêtes pour la production avec accès aux services Business ou Entreprise de ZetCollect",
  "pricing.section2.enterprise.features.tokens": "Recevez jusqu'à 50 000 XAF en jetons",
  "pricing.section2.enterprise.features.payBeyondTokens": "Payez au-delà des seuils de jetons",
  "pricing.section2.enterprise.features.scaleWorkloads": "Les charges de travail s'adaptent au-delà des seuils de jetons",
  "pricing.section2.enterprise.features.allServices": "Accès à tous les services et fonctionnalités de ZetCollect",
  ...
  "pricing.compareFeatures.branchSetup": "Configuration des succursales et institutions",
  ...
  "pricing.compareFeatures.userAccessRoles": "Accès utilisateur et rôles",
  "pricing.compareFeatures.dailySynchronization": "Synchronisation quotidienne des données",
  ...
  "pricing.compareFeatures.missedCollectionAlerts": "Alertes de collecte manquée",
  "pricing.compareFeatures.clientRiskProfile": "Profilage des risques clients",
  "pricing.compareFeatures.routeOptimization": "Optimisation des itinéraires et horaires",
  "pricing.compareFeatures.clientSelfAccessPortal": "Portail d'auto-service client",
  "pricing.compareFeatures.MobileMoney": "Monnaie mobile (à venir)",
  "pricing.compareFeatures.localBusinessHours": "Support pendant les heures de bureau locales",
  ...
  "pricing.compareFeatures.customBranding": "Marque personnalisée",
  ...
  "pricing.compareFeatures.support": "Support",
  "pricing.compareFeatures.support.business": "Heures de bureau locales",
  "pricing.compareFeatures.support.enterprise": "Support entreprise 24/7",
  "pricing.compareFeatures.accountBusiness": "Ingénieur de support",
  "pricing.compareFeatures.accountEnterprise": "Spécialiste de compte technique",
  ...
  "upcoming.portal.title": "Portal ya Mteja",
  ...
  "upcoming.mobile_money.desc": "ZetCollect inaongeza uungaji wa Orange Money na MTN Mobile Money, kuruhusu miamala ya moja kwa moja na malipo salama kupitia vifaa vya simu.",
    ...
    //pricing page
  "pricing.section1.title": "Bei za ushindani kwa ukuaji wa haraka",
  "pricing.section1.description": "Mipango ya bei na malipo inayoweza kubadilika inayofaa Biashara za ukubwa wote.",
  "pricing.section1.cta": "Anza",
  "pricing.section2.title": "Wateja wapya wanapata hadi 50,000 XAF katika tokeni",
  "pricing.section2.description": "Wateja wapya wa ZetCollect wanaweza kuanza bila gharama yoyote na ZetCollect Free Tier. Pata tokeni 500 baada ya kujiandikisha. Tokeni hizi 500 ni sawa na 50,000 XAF. Wanaweza kujaribu huduma za ZetCollect na Mpango wa Bure kwa hadi mwezi 1. Hautatozwa isipokuwa uamue kuchagua Mpango wa Kulipia, ambao hukuruhusu kuongeza shughuli zako na kupata huduma Zote Zetu.",
  "pricing.section2.business.title": "Mpango wa Biashara",
  "pricing.section2.business.description": "Pata uzoefu wa ZetCollect kwa hadi mwezi 1 bila gharama au kujitolea",
  "pricing.section2.business.features.title": "Unapata:",
  "pricing.section2.business.features.freeTrial": "Pata uzoefu wa ZetCollect kwa hadi mwezi 1 bila gharama au kujitolea",
  "pricing.section2.business.features.tokens": "Pokea hadi 50,000 XAF katika tokeni",
  "pricing.section2.business.features.selectServices": "Inajumuisha matumizi ya bure ya huduma Zilizochaguliwa",
  "pricing.section2.business.features.noCharges": "Hakuna gharama zinazotozwa isipokuwa ubadilishe kwenye Mpango wa Kulipia",
  "pricing.section2.business.features.enterpriseServices": "Upatikanaji wa huduma za Biashara",
  "pricing.section2.business.features.allServices": "Upatikanaji wa huduma na vipengele vyote vya ZetCollect",
  "pricing.section2.business.cta": "Anza",
  "pricing.section2.enterprise.title": "Mpango wa Biashara",
  "pricing.section2.enterprise.description": "Tumia mizigo ya kazi iliyo tayari kwa uzalishaji na upatikanaji wa huduma za Biashara au Biashara za ZetCollect.",
  "pricing.section2.enterprise.features.title": "Unapata:",
  "pricing.section2.enterprise.features.productionWorkloads": "Tumia mizigo ya kazi iliyo tayari kwa uzalishaji na upatikanaji wa huduma za Biashara au Biashara za ZetCollect",
  "pricing.section2.enterprise.features.tokens": "Pokea hadi 50,000 XAF katika tokeni",
  "pricing.section2.enterprise.features.payBeyondTokens": "Lipa zaidi ya viwango vya tokeni",
  "pricing.section2.enterprise.features.scaleWorkloads": "Mizigo ya kazi inaweza kuongezeka zaidi ya viwango vya tokeni",
  "pricing.section2.enterprise.features.allServices": "Upatikanaji wa huduma na vipengele vyote vya ZetCollect",
  ...
  "pricing.compareFeatures.collectorManagement": "Usimamizi wa Wakala",
  "pricing.compareFeatures.branchSetup": "Usanidi wa Tawi na Taasisi",
  "pricing.compareFeatures.mobileCollection": "Kiolesura cha Kukusanya kwa Simu",
  "pricing.compareFeatures.bookletSystem": "Mfumo wa Kijitabu",
  "pricing.compareFeatures.transactionHistory": "Historia ya Shughuli",
  "pricing.compareFeatures.reportsAnalytics": "Ripoti na Uchanganuzi",
  "pricing.compareFeatures.userAccessRoles": "Upatikanaji wa Mtumiaji na Majukumu",
  ...
  "pricing.compareFeatures.gpsTraceability": "Ufuatiliaji wa GPS kwa Mawakala",
  "pricing.compareFeatures.missedCollectionAlerts": "Arifa za Kukusanya Zilizokosa",
  "pricing.compareFeatures.clientRiskProfile": "Profaili ya Hatari ya Mteja",
  ...
  "pricing.compareFeatures.MobileMoney": "Pesa za Simu (Zinazokuja)",
  "pricing.compareFeatures.localBusinessHours": "Msaada wa Saa za Biashara za Mitaa",
  "pricing.compareFeatures.enterpriseSupport": "Msaada wa Biashara wa 24/7",
  "pricing.compareFeatures.smsNotifications": "Arifa za SMS",
  "pricing.compareFeatures.smsNotifications.business": "Kwa Mahitaji",
  "pricing.compareFeatures.smsNotifications.enterprise": "Kwa Mahitaji",
  "pricing.compareFeatures.customDomain": "Domeni ya Desturi",
  "pricing.compareFeatures.customDomain.business": "Chaguo-msingi",
  "pricing.compareFeatures.customDomain.enterprise": "Domeni ya Kibinafsi",
  "pricing.compareFeatures.customBranding": "Chapa ya Desturi",
  ...
  "pricing.compareFeatures.support.enterprise": "Msaada wa Biashara wa 24/7",
  "pricing.compareFeatures.accountBusiness": "Mhandisi wa Msaada",
  "pricing.compareFeatures.accountEnterprise": "Mtaalamu wa Akaunti ya Kiufundi",
