...
const translations = {
  ...
  fr: {
    ...
    'upcoming.subtitle': 'Fonctionnalités passionnantes à venir pour améliorer votre expérience de collection',
    'upcoming.gps.title': 'Traçabilité GPS',
    'upcoming.gps.desc': 'Suivi de localisation en temps réel pour une sécurité renforcée et optimisation des itinéraires.',
    'upcoming.alerts.title': 'Alertes de Collections Manquées',
    'upcoming.alerts.desc': 'Notifications automatisées pour collections manquées et rappels de suivi.',
    'upcoming.risk.title': 'Profil de Risque et Notation Client',
    'upcoming.risk.desc': 'Système d\'évaluation des risques et notation client alimenté par IA pour de meilleures décisions.',
    'upcoming.route.title': 'Optimisation d\'Itinéraires et Horaires',
    'upcoming.route.desc': 'Algorithmes de routage intelligent pour optimiser les horaires des collecteurs et maximiser l\'efficacité.',
    'upcoming.portal.title': 'Portail d\'Accès Client',
    'upcoming.portal.desc': 'Permettre aux clients de consulter leur historique de collection et effectuer des paiements indépendamment.',
  ...
  sw: {
    ...
    // Upcoming Features
    'upcoming.title': 'Vipengele Vinavyokuja',
    'upcoming.subtitle': 'Vipengele vya kusisimua vinavyokuja hivi karibuni ili kuboresha uzoefu wako wa ukusanyaji',
    'upcoming.gps.title': 'Ufuatiliaji wa GPS',
    'upcoming.gps.desc': 'Ufuatiliaji wa mahali wa wakati halisi kwa usalama ulioongezeka na kuboresha njia.',
    'upcoming.alerts.title': 'Arifa za Ukusanyaji Uliopotea',
    'upcoming.alerts.desc': 'Arifa za kiotomatiki kwa ukusanyaji uliopotea na vikumbusho vya kufuatilia.',
    'upcoming.risk.title': 'Profaili ya Hatari ya Mteja na Ukadiriaji',
    'upcoming.risk.desc': 'Mfumo wa ukadiriaji wa hatari unaotumia akili bandia na ukadiriaji wa mteja kwa maamuzi bora.',
    'upcoming.route.title': 'Kuboresha Njia na Ratiba',
    'upcoming.route.desc': 'Algoriti za njia mahiri za kuboresha ratiba za wakusanya na kuongeza ufanisi.',
    'upcoming.portal.title': 'Tovuti ya Ufikiaji wa Mteja',
    'upcoming.portal.desc': 'Ruhusu wateja kuangalia historia yao ya ukusanyaji na kufanya malipo kwa kujitegemea.',
